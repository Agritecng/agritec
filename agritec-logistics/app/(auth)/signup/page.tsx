...
export default function SignUpPage() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitMessage(
        "Signup submitted. Your company is pending admin verification.",
      );
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(event) =>
                  handleChange("contactPersonName", event.target.value)
                }
                className="mt-2"
                disabled={isLoading}
              />
          ...
          <div>
            ...
            <Input
              ...
              onChange={(event) =>
                handleChange("businessAddress", event.target.value)
              }
              className="mt-2"
              disabled={isLoading}
            />
